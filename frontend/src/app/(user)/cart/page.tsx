...
const CartPage = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'PM001' | 'PM002'>('PM001'); // PM001: Cash, PM002: Online
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl">
            ...
            <div className="p-6 pt-0 flex gap-3 pb-8">
              <Link href="/orders" className="flex-1 text-center px-6 py-3 bg-gray-100 text-gray-700 rounded-full font-bold hover:bg-gray-200">
                Xem đơn hàng
              </Link>
